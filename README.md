...
To build the final jar and optimize the msstudygateway application for production, run:
...
Then navigate to [http://localhost:8280](http://localhost:8280) in your browser.
